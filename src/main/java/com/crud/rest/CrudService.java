...
public class CrudService {
	...
	public List<Uf> ufs(){
		...
		for (UfEntity entity : listaEntity) {
			ufs.add(new Uf(entity.getId(), entity.getNome(), entity.getSigla(), entity.getDataInclusao(), entity.getDataAlteracao()));
		}
	...
	private UfEntity newEntity(Uf uf,UfEntity entity){		
		entity.setId(uf.getId());
		entity.setNome(uf.getNome());
		entity.setSigla(uf.getSigla());
		return entity;
	}
}
